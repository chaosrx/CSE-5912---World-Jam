...
public class StartVote : NetworkBehaviour {
    ...
    void Start()
   {
        //Debug.Log("Started: " + started + " totalTime: " + totalTime + " countDownLength: " + countDownLenght);
	...
	void FixedUpdate () {
        ...
        else if (totalTime < countDownLenght)
        {
            ...
            //Debug.Log(totalTime + " " + Time.deltaTime);
