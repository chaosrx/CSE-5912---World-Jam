...
public class ClickToLoad : MonoBehaviour {
    ...
    private string[] tips =
    {
        "Perform a ground slide into players of lesser momentum to trip them up",
        ...
        "Get good...",
        "Don't get salty, this game is perfect"
    };
    ...
    IEnumerator LoadLevelWithBar(string sceneName)
    {
        ...
        while (!async.isDone)
        {
            loadingPercentage.text = "Loading " + Mathf.CeilToInt(async.progress*100) + "%";
